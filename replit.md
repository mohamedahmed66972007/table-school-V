...
- **Features**: 
  ...
  - واجهة مستقلة على سطح المكتب
  - تكامل كامل مع Express backend
  - دعم RTL كامل في النافذة
- **Scripts**:
  - `npm run electron:dev` - تشغيل في وضع التطوير
...
- **Configuration**: `electron-builder.yml` و `package.json` (build section)
- **Documentation**: راجع `ELECTRON_GUIDE.md` للدليل الكامل
